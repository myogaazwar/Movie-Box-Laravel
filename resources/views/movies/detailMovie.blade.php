            ...
            <div class="mt-5 sm:mt-0">
                ...
                @if ($isFavorite)
                    <form method="POST"
                        ...
                        <button id="btn_removeFavorite" class="mt-5 bg-primary text-white px-4 py-2 rounded inline-flex items-center gap-x-2">
                        ...
                        <span class="pl-8">
                            {{ __('detailMovie.btn_remove_favorite') }}
                        </button>
                    </form>
                @else
                    <form method="POST"
                        ...
                        @csrf
                        <button id="btn_addFavorite" class="mt-5 bg-primary text-white px-4 py-2 rounded inline-flex items-center gap-x-2">
                               <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6 w-5 text-white absolute">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                        ...
                        <span class="pl-8">
                            {{ __('detailMovie.btn_add_favorite') }}
                        </span>
                        </button>
